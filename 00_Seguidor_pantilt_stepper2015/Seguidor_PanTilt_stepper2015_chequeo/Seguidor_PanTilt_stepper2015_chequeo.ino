...
int reference;
int pinIrrad=A0;
float angulo_retorno=92.0; //angulo cenital para decir cuando vuelve a reposo
int noche=0;
...
#endif
  rtc.begin();
//rtc.adjust(DateTime(2015, 3, 18, 16, 57, 30));
  if (! rtc.isrunning()) {
...
void inicializa(){
  ...
  int pasos_giro=40;
    ...
    iniciado=true;
     ...
     Serial.println(F("Pasos hasta el sol:"));
    ...
    //pasos=200;
    Serial.println(F("Posicionando en acimut:"));
     Serial.print(acimut_sol2);
