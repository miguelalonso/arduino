...
SoftwareSerial mySerial(14,12,false,128);// D5(RX), D6(TX) nodemcu
...
float fIAC;
float fPAC;
float fPRL; //da el % de potencia de operación
/*float fCAC; //startups??
float fKYR;//energy year
float fKLY; //energy last year
float fKMT;//energy month
...
void sendData_emon(void){
  ...
  if (client_emon.connect(server_emon, 80)) {
    ...
    client_emon.print(valor);
    valor=  mydata.PAC/2;
    client_emon.print(F(",PAC:")); client_emon.print(valor);
    valor=  mydata.VDC/10;
    client_emon.print(F(",VDC:")); client_emon.print(valor);
    valor=  mydata.IDC/100;
    client_emon.print(F(",IDC:")); client_emon.print(valor);
    valor=  mydata.VAC/10;
    client_emon.print(F(",VAC:")); client_emon.print(valor);
    valor=  mydata.IAC/100;
    client_emon.print(F(",IAC:")); client_emon.print(valor);
    client_emon.print(F(",PRL:")); client_emon.print(mydata.PRL);
    client_emon.print(F(",KYR:")); client_emon.print(mydata.KYR);
    client_emon.print(F(",KMT:")); client_emon.print(mydata.KMT);
    client_emon.print(F(",KDY:")); client_emon.print(mydata.KDY);
    client_emon.print(F(",KT0:")); client_emon.print(mydata.KT0);
    client_emon.print(F(",TKK:")); client_emon.print(mydata.TKK);
    client_emon.print(F(",cnt:")); client_emon.print(mydata.cnt);
    client_emon.print(F(",KLY:")); client_emon.print(mydata.KLY);
    client_emon.print(F(",KHR:")); client_emon.print(mydata.KHR);
    client_emon.print(F(",KLD:")); client_emon.print(mydata.KLD);
    client_emon.print(F(",CAC:")); client_emon.print(mydata.CAC);
    client_emon.print(F(",KLM:")); client_emon.print(mydata.KLM);
...
void imprimirdatos(void){
  ...
  */
  ...
  Serial.print("VAC: ");
  Serial.println(mydata.VAC);
  Serial.print("IAC: ");
  Serial.println(mydata.IAC);
  Serial.print("VDC: ");
  Serial.println(mydata.VDC);
  Serial.print("IDC: ");
  Serial.println(mydata.IDC);
  Serial.print("KDY: ");
  Serial.println(mydata.KDY);
...
void setup() {
  ...
  ET.begin((byte*)&mydata,34, &mySerial);
...
if(ET.receiveData()){
    ...
    Serial.println("Data received from nano, PAC, counter");
    Serial.println(mydata.PAC);
    Serial.println(mydata.cnt);
    Serial.println(mydata.KLD);
    Serial.println(mydata.VAC);
    imprimirdatos();
  }
if ((millis()-t_ant_solarmax)>t_solarmax){
         t_ant_solarmax=millis();
         // medir(); ///mide los lux si el sensor está habilitado
          chequeaSolarmax();
           datosOK=true;
}
